...
<a href="menu.php" rel="nofollow" onclick="goback()"><img src="left.png" border="0" title="<!- กลับ ->"/></a><br />
...
<div id="apDiv1"><img src="nfe.gif"></div>
<div id="apDiv3">
...
?>
  ...
  <table width="692" height="150" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
  <tr>
  ...
  <tr>
    <td class="background1" width="295" align="right" valign="top"><span class="style5">
      <?
...
?>
  ...
  <span class="style5">ตำแหน่ง เจ้าหน้าที่การเงินและบัญชี</span>
<? } ?>
